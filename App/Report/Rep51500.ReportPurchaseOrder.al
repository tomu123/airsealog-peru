report 51500 "Rpts. Purchase Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './App/Report/RDLC/Rpts. Purchase Order.rdl';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Ubigeo_Vendor; UbigeoMgt.ShowUbigeoDescription(gRecVendor."Country/Region Code",
            ...
            column(Telefono; gRecVendor."Phone No.")
            {
            }
            column(Fax; gRecVendor."Fax No.")
            {
            }
            column(FechaOC; "Purchase Header"."Posting Date")
            {
            }
            column(Moneda; gMoneda)
            {
            }
            ...
            column(gApprovalIds; gApprovalIds) { }
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                begin
                    ...
                    gRecPurchaseComment.SetRange("Document Type", gRecPurchaseComment."Document Type"::Order);
            ...
            begin
                ...
                if ApprovalEntry.FindSet then
                    repeat
                        gApprovalIds += ApprovalEntry."Approver ID" + ', ';
