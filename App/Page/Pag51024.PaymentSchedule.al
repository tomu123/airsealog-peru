            ...
            group(Actions2)
            {
                ...
                action(CallModifyRecipientsBankAccount)
                {
                    ...
                    begin
                        ...
                        lcPgStandDialogPage.fnActivateRequest(8);
                        lcPgStandDialogPage.fnSetPaymentSchedule("Entry No.");
                        ...
                        if lcPgStandDialogPage.RUNMODAL IN [ACTION::LookupOK, ACTION::OK] then begin
                            ...
                            lcPgStandDialogPage.fnGetParameterEight(lcRecPaymentSchedule."Payment Method Code", lcRecPaymentSchedule."Preferred Bank Account Code");
