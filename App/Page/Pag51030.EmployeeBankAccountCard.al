page 51030 "ST Employee Bank Account Card"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Code"; Code)
                {
                    ...
                    ToolTip = 'Specifies a code to identify this Employee bank account.';
                }
                field(Name; Name)
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the name of the bank where the Employee has the bank account.';
                }
                field(Address; Address)
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the address of the bank where the Employee has the bank account.';
                }
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the city of the bank where the Employee has the bank account.';
                }
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the telephone number of the bank where the Employee has the bank account.';
                }
            ...
            group(SetupLocalization)
            {
                ...
                field("Empl. Name/Business Name"; "Empl. Name/Business Name")
                {
                    ApplicationArea = All;
                }
            ...
            group(Communication)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the fax number of the bank where the Employee has the bank account.';
                }
                field("E-Mail"; "E-Mail")
                {
                    ApplicationArea = Basic, Suite;
