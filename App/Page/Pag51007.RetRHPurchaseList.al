page 51007 "Ret. RH Purchase Invoices"
{
    AdditionalSearchTerms = 'vendor invoice';
    ApplicationArea = Basic, Suite;
    Caption = 'RH Purchase Invoices';
    CardPageID = "Ret. RH Purchase Invoice";
    ...
    SourceTableView = where("Document Type" = const(Invoice), "Legal Document" = const('02'));
    UsageCategory = Lists;
